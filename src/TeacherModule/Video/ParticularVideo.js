...
// create a component
const TeacherParticularVideo = ({navigation}) => {
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
        <View
          style={{backgroundColor: colors.white, padding: 15, marginTop: 5}}>
          ...
          <Text style={[styles.p, {marginTop: 5}]}>
            ...
            plan and construction of public infrastructure like buildings,
            bridges and so on.
          </Text>
        </View>
...
export default TeacherParticularVideo;
